...
// This code is a simple example of how to use a GenAI model to answer questions about math, prime numbers, and cryptocurrency prices.


import { GoogleGenAI } from "@google/genai";
import readlineSync from 'readline-sync';
const History=[];
const ai = new GoogleGenAI({apiKey:"use your API key here"});
